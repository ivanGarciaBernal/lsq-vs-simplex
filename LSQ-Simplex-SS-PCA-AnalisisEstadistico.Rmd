...
```{r cargado de archivos,warning=FALSE,message=FALSE}
...
```{r analisis y graficas,fig.dim = c(10,8),message=FALSE,warning=FALSE}
...
# mtext(parametros, side = 3, line = -0.9, outer = T)
...
# # lo anterior reemplaza esta grafica
# plot(seq(1,6,1),q$res$P.adj,xlab='Comparatives',xaxt = 'n',
#    ylab='p-value',ylim=c(0,1),
...
grid.arrange(plot1, plot2, ncol=2, nrow = 1, top = "Pairwise comparisons of the medians with Bonferroni correction (Dunn test)",bottom = parametros )
...
# #el anterior grafico (plot3) reemplaza al que esta a continuacion
...
# axis(1, at = seq(6), labels = c('LSQ vs S','LSQ vs SS','LSQ vs PCA','S vs PCA','SS vs PCA', 'SS vs S'))
# abline(h=0.05, col="red", lwd=2, lty=2)
# mtext(parametros, side = 3, line = -0.9, outer = T)
# }
...
# plot(seq(1,6,1),p_val_adj,xlab='Comparatives',xaxt = 'n',
#    ylab='p-value',ylim=c(0,1),
#    main='Fligner-Killeen test for pairwise comparisons with Bonferroni correction for p-values (b)')
# axis(1, at = seq(6), labels = c('LSQ vs S','LSQ vs SS','LSQ vs PCA','S vs PCA','SS vs PCA', 'SS vs S'))
# abline(h=0.05, col="red", lwd=2, lty=2)
# mtext(parametros, side = 3, line = -0.9, outer = T)
# }
...
grid.arrange(plot3, plot4, ncol=2, nrow = 1, top = "Pairwise comparisons of the variance with Bonferroni correction (Fligner-Killeen test)",bottom = parametros )
