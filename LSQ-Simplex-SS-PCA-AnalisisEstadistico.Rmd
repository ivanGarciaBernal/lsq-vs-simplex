...
for (i in 1:length(RV)){
  ...
  stat_pvalue_manual(stat.test, y.position =max(median(var.LSQ[,1]),median(var.S[,1]),median(var.SS[,1]),median(var.PCA[,1]))+1, #Un mejor ajuste de las líneas
    ...
    labs(y= "Slope estimations",title="Pairwise comparisons of the medians with Bonferroni correction (Dunn test)") 
    print(plot1)
  ...
  stat_pvalue_manual(stat.test, y.position =max(median(var.LSQ[,2]),median(var.S[,2]),median(var.SS[,2]),median(var.PCA[,2]))+1, #Un mejor ajuste de las líneas
    ...
    labs(y= "Intercepts estimations",title="Pairwise comparisons of the medians with Bonferroni correction (Dunn test)") 
    print(plot2)
  ...
  stat_pvalue_manual(stat.test, y.position =max(median(var.LSQ[,1]),median(var.S[,1]),median(var.SS[,1]),median(var.PCA[,1]))+1, #Un mejor ajuste de las líneas
    ...
    labs(y= "Slopes estimations",
	 title="Pairwise comparisons of the variance with Bonferroni correction (Fligner-Killeen test)") 
    print(plot3)
